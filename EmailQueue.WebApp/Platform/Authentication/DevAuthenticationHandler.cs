...
// Provides an authenticated user when running in development.
internal class DevAuthenticationHandler(
    ...
    AuthenticationHandler<AuthenticationSchemeOptions>(options, logger, encoder)
{
    ...
    protected override async Task HandleChallengeAsync(AuthenticationProperties properties)
    {
        ...
        await Response.BodyWriter.WriteAsync(
            Encoding.UTF8.GetBytes("Status Code: 403; Forbidden \r\n" +
                                   "To access protected pages, set 'DevAuthFails' to 'false'."));
    }
}
